...
{
    public class GetOrdersQueryHandler(IUnitOfWork uow) : IRequestHandler<GetOrdersQuery, IEnumerable<OrderDTO>>
    {
        public async Task<IEnumerable<OrderDTO>> Handle(GetOrdersQuery request, CancellationToken cancellationToken)
        {
            var orderProductsGrouped = uow.OrderProduct.FullJoin();
